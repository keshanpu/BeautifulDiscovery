 ...
 */
public class CategoryOthersAdapter extends BaseAdapter{
    ...
    public CategoryOthersAdapter(Context context, List<CategoryBean.DataBean.CategoriesBean.SubCategoriesBean> sub_categories, OthersFragment othersFragment) {
        mContext = context;
    ...
    class ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            othersFragment.refreshView(id, name);
        }
    }
}
