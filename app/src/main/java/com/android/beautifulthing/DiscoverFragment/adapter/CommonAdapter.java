...
public class CommonAdapter extends BaseAdapter {
    ...
    private List<CommonBean.DataBean.ProductsBean> dataList;
    private LayoutInflater mInflater;

    public CommonAdapter(Context context, List<CommonBean.DataBean.ProductsBean> productsBeanList) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //获取位置
        CommonBean.DataBean.ProductsBean productsBean = dataList.get(position);
        //向控件填值
