 ...
 */
public class CategoryAccAdapter extends BaseAdapter{
    ...
    public CategoryAccAdapter(Context context, List<CategoryBean.DataBean.CategoriesBean.SubCategoriesBean> sub_categories, AccessoryFragment accessoryFragment) {
        mContext = context;
        categoriesList = sub_categories;
        mInflater = LayoutInflater.from(mContext);
        this.accessoryFragment = accessoryFragment;
    }
    ...
    class ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            accessoryFragment.refreshView(id, name);
        }
    }
}
