 ...
 */
public class CategoryShoesAdapter extends BaseAdapter{
    ...
    public CategoryShoesAdapter(Context context, List<CategoryBean.DataBean.CategoriesBean.SubCategoriesBean> sub_categories, ShoesFragment shoesFragment) {
        mContext = context;
        categoriesList = sub_categories;
        mInflater = LayoutInflater.from(mContext);
        this.shoesFragment = shoesFragment;
    }
    ...
    class ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            shoesFragment.refreshView(id, name);
        }
    }
}
