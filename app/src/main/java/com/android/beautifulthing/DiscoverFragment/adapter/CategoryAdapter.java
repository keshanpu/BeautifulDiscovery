...
public class CategoryAdapter extends BaseAdapter{
    ...
    public CategoryAdapter(Context context, List<CategoryBean.DataBean.CategoriesBean.SubCategoriesBean> sub_categories, JewelryFragment jewelryFragment) {
        mContext = context;
    ...
    class ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            jewelryFragment.refreshView(id, name);
        }
    }
}
