...
public interface HttpService {
    ...
    // 分类：/api/v1/product/categories/
    @GET("/api/v1/product/categories")
    Call<CategoryBean> getCategoryDatas();

    // 评论：/api/v1/comments/product/1129
    @GET("/api/v1/comments/product/{product_id}")
    Call<CommentBean> getCommentsDatas(@Path("product_id")int product_id);
